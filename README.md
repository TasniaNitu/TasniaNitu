...
Building practical, user-focused AI applications across machine learning, natural language processing, and generative AI.
...
<a href="mailto:kazitasnia20@gmail.com">
  <img
...
- Calculates candidate-match scores and automatically ranks applicants
- Provides an interactive public Streamlit application

**Tech Stack**

`Python` • `Sentence Transformers` • `scikit-learn` • `PyPDF2` • `Streamlit`

🔗 [View Repository](https://github.com/TasniaNitu/resume-screener)  
🌐 [Open Live Demo](https://tasnianitu-resume-screener.streamlit.app/)
...
- Fine-tuned BERT on the WELFake dataset
- Achieved **99.11% test accuracy** and **99.13% F1-score**
- Packaged model inference as a FastAPI REST API
...
`Python` • `LangChain` • `Ollama` • `Plotly` • `Streamlit`

🔗 [View Repository](https://github.com/TasniaNitu/finance-ai-assistant)
...
- Cloud deployment for machine learning applications
...
- 🌐 Portfolio: [tasnianitu.github.io](https://tasnianitu.github.io)
- 💼 LinkedIn: [linkedin.com/in/tasnia-ai](https://linkedin.com/in/tasnia-ai)
